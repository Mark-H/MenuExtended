...
It does lack extended support for contexts, menus nested more than one level deep, twenty-bazillion configuration properties and processor intensive scripting.
